    ...
    <div class="col-md-6 offset-md-3">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <?= $this->flash->output() ?>
                <form method="post" action="<?= $this->url->get('authorizedUsers/resetPassword') ?>">
                    ...
                    <div class="modal-footer">   
                        <button type="submit" class="btn btn-primary"><i class="fas fa-save" aria-hidden="true"></i> Reset Password</button>  
                    </div>
                </form>
