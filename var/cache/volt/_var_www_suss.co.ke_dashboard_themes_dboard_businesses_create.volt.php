    ...
    <div class="page-title-wrapper">
        ...
        <div class="page-title-actions">
            <div class="d-inline-block ">  
                <?= $this->tag->linkTo(['businesses', 'class' => 'btn-shadow btn btn-alternate', '<span class="btn-icon-wrapper pr-2 opacity-7"><i class="fas fa-arrow-left fa-w-20"></i></span> Go Back']) ?>
            </div>
        </div>    
    </div>
</div>    
    ...
    <div class="col-lg-12">
        ...
        <div class="main-card mb-3 card">
            ...
            <div class="card-body"><h5 class="card-title mb-5">Enter the Businesses Details Below</h5>
                ...
                <form role="form" method="post" action="<?= $this->url->get('businesses/create') ?>">
                    ...
                    <div class="modal-footer">    
                        <?= $this->tag->tagHtml('button', ['id' => 'saveNewUser', 'type' => 'submit', 'class' => 'btn-shadow btn btn-primary btn-lg ml-3'], false, true, true) ?>
                            <span class="btn-icon-wrapper pr-2 opacity-7"><i class="fas fa-save fa-w-20"></i></span>  Create New Business
