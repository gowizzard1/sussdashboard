                ...
                <table class="display mb-0 table" id="campaign" style="width:100%;"> 
                    ...
                    <tbody>
                        {% for campaign in campaigns %} 
							{% set cpm = campaign.cpm %}
							{% set ctr = campaign.ctr %}
							{% if (campaign.clicks*4 > campaign.impressions) %}
							{% set cpm = 0 %}
							{% set ctr = 0 %}
							{% endif %}
                            <tr>
                                <th scope="row">{{ campaign.campaign_id }}</th>
                                <td>{{ link_to('dashboard/details/' ~ campaign.campaign_id , campaign.campaign_name) }}</td>
